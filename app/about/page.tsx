        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              {/* TODO: Replace with real hospital photo */}
              <Image
                src="https://picsum.photos/600/500?random=201"
                alt="Deep Superspeciality Hospital building — Bhavani Peth, Solapur"
                width={600}
                height={500}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-8 items-center">
            ...
            {/* TODO: Replace with real lab/OT photo */}
            <Image
              src="https://picsum.photos/600/400?random=202"
              alt="Deep Hospital operation theatre and ICU facilities"
              width={600}
              height={400}
              className="rounded-lg w-full object-cover"
            />
