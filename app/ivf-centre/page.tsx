...
import { FAQS_IVF } from "@/lib/constants";
...
export default function IVFCentrePage() {
  return (
    <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {treatments.map((treatment) => (
              <div
                key={treatment.name}
                className="bg-warm-white rounded-lg border border-soft-grey p-6"
      ...
      {/* CTA */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-teal-heal text-center">
